...
- `小黑 /status`、`小黑 /memory-list [頁碼]`、`小黑 /memory-trash [頁碼]`、`小黑 /forget <ID>`、`小黑 /restore <ID>` 與 `小黑 /memory-clear confirm` 只允許 `KURO_COMMAND_USER_IDS` 中的使用者。記憶列表每頁顯示 5 條，省略頁碼時顯示第 1 頁。
